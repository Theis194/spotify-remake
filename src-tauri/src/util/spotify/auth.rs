...
pub fn get_authorization_url(client_id: &str, redirect_uri: &str) -> String {
    ...
    let scopes = "user-read-private%20user-read-email%20user-top-read%20playlist-read-private%20user-read-playback-state%20user-modify-playback-state%20user-read-recently-played%20streaming";
