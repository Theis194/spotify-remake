...
pub fn SideNav() -> impl IntoView {
    view! {
        <div class="sidebar bg-neutral text-neutral-content space-y-6 py-2 px-2 absolute inset-y-0 left-0 transform -translate-x-full sm:relative sm:translate-x-0 transition duration-200 ease-in-out">
            <nav>
